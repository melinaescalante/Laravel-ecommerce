        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse d-flex align-items-center gap-5" id="navMain">
                ...
                <div class="text-end ms-auto">
                    <x-navlink route="cart">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10%" height="10%" viewBox="0 0 24 24" fill="none">
                            <path d="M6.3 5H21L19 12H7.38M20 16H8L6 3H3M9 20C9 20.55 8.55 21 8 21C7.45 21 7 20.55 7 20C7 19.45 7.45 19 8 19C8.55 19 9 19.45 9 20ZM20 20C20 20.55 19.55 21 19 21C18.45 21 18 20.55 18 20C18 19.45 18.45 19 19 19C19.55 19 20 19.45 20 20Z" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </x-navlink>
                </div>
            </div>
